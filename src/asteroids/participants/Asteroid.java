...
public class Asteroid extends Participant implements ShipDestroyer, AlienDestroyer
{
    ...
    public void collidedWith (Participant p)
    {
        ...
        if (p instanceof AsteroidDestroyer)
        {
            ...
            if (this.controller.getEnhanced())
            {
                controller.getSounds().play("shot");
            }
            if (!this.controller.getEnhanced())
            {
                if (size == 2)
                {
                    controller.getSounds().play("destroyedB");
                }
                else if (size == 1)
                {
                    controller.getSounds().play("destroyedB");
                ...
                {
                    controller.getSounds().play("destroyedS");
                }
            }
            ...
            if (size >= 0)
            {
                if (size == 1)
                {
                    controller.addParticipant(new Asteroid(RANDOM.nextInt(4), size, getX(), getY(),
                            RANDOM.nextInt(5 - 3) + 3, controller));
                    controller.addLocation(this, controller.getListNumber());
                    controller.addParticipant(new Asteroid(RANDOM.nextInt(4), size, getX(), getY(),
                            RANDOM.nextInt(5 - 3) + 3, controller));
                    controller.addLocation(this, controller.getListNumber());
                ...
                {
                    controller.addParticipant(new Asteroid(RANDOM.nextInt(4), size, getX(), getY(),RANDOM.nextInt(FAST_ASTEROID_SPEED-SLOW_ASTEROID_SPEED) + SLOW_ASTEROID_SPEED, controller));
                    controller.addLocation(this, controller.getListNumber());
                    controller.addParticipant(new Asteroid(RANDOM.nextInt(4), size, getX(), getY(),RANDOM.nextInt(FAST_ASTEROID_SPEED-SLOW_ASTEROID_SPEED)+SLOW_ASTEROID_SPEED, controller));
                    controller.addLocation(this, controller.getListNumber());
                }
                ...
                {
                    controller.addParticipant(new Asteroid(RANDOM.nextInt(4), size, getX(), getY(), SLOW_ASTEROID_SPEED, controller));
                    controller.addLocation(this, controller.getListNumber());
                    controller.addParticipant(new Asteroid(RANDOM.nextInt(4), size, getX(), getY(), SLOW_ASTEROID_SPEED, controller));
                    controller.addLocation(this, controller.getListNumber());
                }
